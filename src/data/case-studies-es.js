const caseStudiesES = {
  ...
  bigImage: {
    title: 'Parte del Trabajo que Hemos Hecho',
    description: 'Sitios web, aplicaciones web, aplicaciones móviles, APIs y mucho más'
  },
  proyects: {
  ...
  cases: {
    ...
    deliveryapp: {
      ...
      plansAndPrices: {
        ...
        description: "Targi está pensando para PyMEs, con precios que negocios pequeños pueden asumir.",
        subtitle: "¿Donde está tu negocio?",
        titleOtherCountry: "Otro País",
        titleMonthly: "Mensual",
        monthlydesc: "Pagas mes a mes",
        titleAnnual: "Anual",
        annualDesc: "Un solo pago de ",
        annualLowCost: "Precio más bajo",
        month: "mes",
        btnCompra: "Comprar",
        titleCost: "Costo de Instalación",
  ...
  seemore: "Ver Más Casos de Estudio"
}
